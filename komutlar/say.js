 ...
 let güvenlik = message.guild.verificationLevel
  ...
  let  çevrimiçi = message.guild.members.cache.filter(m => !m.user.bot && m.user.presence.status !== "offline").size
    const embed = new Discord.MessageEmbed()
        ...
        .addField(`<a:sonsuz:781403116066832384>  **__Boost Seviyesi__**`,`»  **${message.guild.premiumTier}/3**`)
    
        .addField(`<a:ses:781403115508727818>  **__Boost Sayısı__**`,`»  **${message.guild.premiumSubscriptionCount}**`)
